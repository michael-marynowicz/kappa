error id: file:///C:/Users/mmarynowicz/Downloads/sprint-reporter-v2/sprint-reporter/backend/src/test/java/com/company/sprintreporter/service/CsvExportServiceTest.java:com/company/sprintreporter/service/CsvExportServiceTest#assertThat#contains#describedAs#
...
empty definition using pc, found symbol in pc: com/company/sprintreporter/service/CsvExportServiceTest#assertThat#contains#describedAs#
...
class CsvExportServiceTest {
    ...
    void computesCorrectMetrics() {
        ...
        assertThat(csv).contains("Yes").@@describedAs("Sprint success should be No because 5 < 8").isNotNull();
    }
